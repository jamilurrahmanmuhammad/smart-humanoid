...
class TestChatEndpoint:
    ...
    def test_chat_returns_200(self, mock_env) -> None:
        ...
        # Mock at the service level before importing app
        with patch("services.rag.EmbeddingService"), \
            ...
            # Patch RAGPipeline.query to return our mock result
            with patch("api.routes.chat.RAGPipeline") as mock_pipeline:
                mock_pipeline.return_value.query = AsyncMock(return_value=mock_rag_result)
